...
public class StoreOrdersFile {
	
	public void createFile  (String fn, Orders_List list) {
		Orders_List ord_list=list;
		File f=null;
		...
		try	{
		    ...
		    for (int i=0; i<ord_list.Entries(); i++) {
				dev=ord_list.Dev(i).getDevice();
				writer.write("\n"+"\t"+"ORDER"+"\n"+"\t"+"{"+"\n"+"\t"+"\t");
				...
				+"\n"+"\t"+"\t"+"STOCK "+dev.getStock()
				+"\n"+"\t"+"\t"+"PRICE "+dev.getPrice()
				+"\n"+"\t"+"\t"+"ORDER_NUMBER "+ord_list.Dev(i).getCodeOfOrder()
				+"\n"+"\t"+"\t"+"CUSTOMER "+ord_list.Dev(i).getCustomer()
				+"\n"+"\t"+"\t"+"PHONE "+ord_list.Dev(i).getPhone()
				+"\n"+"\t"+"\t"+"ORDER_DATE "+ord_list.Dev(i).getDate()
				+"\n"+"\t"+"\t"+"DELIVERY_DATE "+ord_list.Dev(i).getArrival_Date()
				+"\n"+"\t"+"\t"+"FINAL_PRICE "+ord_list.Dev(i).getFinal_Price()
				+"\n"+"\t"+"\t"+"ORDER_STATUS "+ord_list.Dev(i).getStatus()
				+"\n"+"\t"+"}");
		    }
			writer.write("\n"+"}");
        }
